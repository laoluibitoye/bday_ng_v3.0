    ...
    class macho_bootstrap_walker extends Walker_Nav_Menu{
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0){
            ...
            if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
                ...
                if (is_object($args) && isset($args->has_children) && $args->has_children && $depth === 0) {
                    $atts['href'] = $item->url;
                ...
                $item_output .= (is_object($args) && isset($args->has_children) && $args->has_children && 0 === $depth) ? ' <span class="caret"></span></a>' : '</a>';
